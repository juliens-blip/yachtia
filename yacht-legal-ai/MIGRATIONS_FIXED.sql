-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
-- Migration 014: Add new flag categories (FIXED)
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

-- ÉTAPE 1: Vérifier les catégories existantes
SELECT DISTINCT category FROM documents ORDER BY category;

-- ÉTAPE 2: Supprimer la contrainte existante
ALTER TABLE documents DROP CONSTRAINT IF EXISTS documents_category_check;

-- ÉTAPE 3: Recréer avec TOUTES les catégories (existantes + nouvelles)
...
CHECK (category IN (
  ...
  'PAVILLON_CAYMAN_REG',
  'GUIDES_PAVILLONS',
  -- Nouvelles catégories (2026-01-15)
  'PAVILLON_FRANCE',
  'PAVILLON_BVI',
  'PAVILLON_IOM',
  'PAVILLON_MADERE'
