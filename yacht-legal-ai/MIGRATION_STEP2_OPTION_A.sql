-- OPTION A: Si vous voyez seulement ces catégories dans STEP1
-- (Utiliser si vous n'avez PAS de catégories inconnues)

-- Supprimer la contrainte temporairement
ALTER TABLE documents DROP CONSTRAINT IF EXISTS documents_category_check;

-- Recréer avec toutes les catégories
...
'Valid document categories including flag registries';
